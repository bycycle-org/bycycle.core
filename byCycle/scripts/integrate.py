...
Example::
    ...
    --source is a GIS data source directory containing shapefiles.
...
Options::
    ...
    --source | -c <data source name>
        The data source. This is a directory containing shapefiles. REQUIRED.
